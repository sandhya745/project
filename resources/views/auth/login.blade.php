            ...
            <div class="p-14">
                ...
                <form method="POST" action="{{ route('login') }}" autocomplete="off">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required
                            ...
                            placeholder="example@gmail.com" autocomplete="off"> <!-- <-- add this -->
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                            placeholder="minimum 6 characters" autocomplete="new-password"> <!-- <-- add this -->
                    </div>
                ...
                {{-- <!-- Continue as Reader -->
                    <div class="text-center mt-4">
                        <a href="{{ route('reader.index') }}" class="text-blue-600 font-semibold hover:underline">
                            Continue as Reader →
                        </a>
                    </div>
