...
<div class="p-6 space-y-6">
    ...
    <p class="text-gray-600 mt-2">
        Welcome to the admin dashboard help page! Here you can find guides, tips, and instructions for managing the system.
    </p>
    ...
    <div class="bg-white p-4 rounded-lg shadow space-y-2">
        ...
        <ul class="list-disc list-inside text-gray-700">
            <li>After logging in, you are directed to the dashboard showing quick stats: total books, genres, authors, and readers.</li>
            <li>Use the sidebar to navigate through sections: Books, Genres, Authors, Users, Reports, Settings, Notifications.</li>
